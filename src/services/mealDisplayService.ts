...
> = {
  ...
  "Soft Scrambled Eggs with Potatoes": { bg: "#FEF3C7", accent: "#92400E", emoji: "🍳" },
  "Soft Oatmeal with Banana":          { bg: "#FFFBEB", accent: "#78350F", emoji: "🥣" },
  "Soft Pancakes with Berry Compote":  { bg: "#FCE7F3", accent: "#9D174D", emoji: "🥞" },
  "Soft Chicken and Rice Bowl":        { bg: "#F0FDF4", accent: "#166534", emoji: "🍚" },
  "Soft Turkey Meatloaf with Potatoes": { bg: "#FEF3C7", accent: "#78350F", emoji: "🍽" },
  "Soft Tuna Rice Casserole":          { bg: "#DBEAFE", accent: "#1E40AF", emoji: "🥘" },
  "Soft Baked Fish with Rice":         { bg: "#CFFAFE", accent: "#155E75", emoji: "🐟" },
  "Soft Beef Stew":                    { bg: "#FDE68A", accent: "#92400E", emoji: "🍲" },
  "Soft Pasta with Meat Sauce":        { bg: "#FEE2E2", accent: "#991B1B", emoji: "🍝" },
  "Spring Soft Herb Chicken with Vegetables": { bg: "#DCFCE7", accent: "#14532D", emoji: "🌿" },
  "Summer Soft Lemon Fish and Rice":          { bg: "#FEF9C3", accent: "#854D0E", emoji: "🍋" },
  "Fall Soft Turkey Sweet Potato Bowl":       { bg: "#FFEDD5", accent: "#9A3412", emoji: "🍠" },
  "Winter Soft Chicken Pot Pie Filling":      { bg: "#EFF6FF", accent: "#1E40AF", emoji: "🥧" },
