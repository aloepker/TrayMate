...
public class MealImageSeeder {
    ...
    private static final Map<String, String> NAME_TO_PERIOD = Map.ofEntries(
        ...
        Map.entry("Soft Scrambled Eggs with Potatoes", "Breakfast"),
        Map.entry("Soft Oatmeal with Banana", "Breakfast"),
        Map.entry("Soft Pancakes with Berry Compote", "Breakfast"),
        Map.entry("Soft Chicken and Rice Bowl", "Lunch"),
        Map.entry("Soft Turkey Meatloaf with Potatoes", "Lunch"),
        Map.entry("Soft Tuna Rice Casserole", "Lunch"),
        Map.entry("Soft Baked Fish with Rice", "Dinner"),
        Map.entry("Soft Beef Stew", "Dinner"),
        Map.entry("Soft Pasta with Meat Sauce", "Dinner"),
        Map.entry("Spring Soft Herb Chicken with Vegetables", "Lunch"),
        Map.entry("Summer Soft Lemon Fish and Rice", "Dinner"),
        Map.entry("Fall Soft Turkey Sweet Potato Bowl", "Lunch"),
        Map.entry("Winter Soft Chicken Pot Pie Filling", "Dinner"),
